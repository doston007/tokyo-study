...
function App() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 dark:from-slate-900 dark:via-slate-800 dark:to-slate-950 flex items-center justify-center p-6">
        <div className="text-center">
          <RefreshCw className="w-12 h-12 text-emerald-500 dark:text-emerald-400 animate-spin mx-auto mb-4" />
          <p className="text-slate-900 dark:text-white text-lg font-semibold">Сотув маълумотлари юкланмоқда...</p>
          <p className="text-slate-600 dark:text-slate-400 mt-2">Google Sheets дан юкланмоқда</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 dark:from-slate-900 dark:via-slate-800 dark:to-slate-950 flex items-center justify-center p-6">
        <div className="bg-red-100 dark:bg-red-900/20 border border-red-300 dark:border-red-500/50 rounded-xl p-8 max-w-md text-center">
          <p className="text-slate-900 dark:text-white text-lg font-semibold mb-4">{uzbekTranslations.errorLoadingData}</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 dark:from-slate-900 dark:via-slate-800 dark:to-slate-950 p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                {showExportMenu && (
                  <div className="absolute top-full right-0 mt-2 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg shadow-lg z-10 overflow-hidden min-w-40">
                    <button
                      onClick={() => {
                        exportToCSV(sortedData, String(selectedTimeframe), selectedBranch);
                        setShowExportMenu(false);
                      }}
                      className="w-full px-4 py-3 text-left text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors border-b border-slate-200 dark:border-slate-700"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 text-left text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                    >
              ...
              <button
                onClick={loadData}
                disabled={loading}
                className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-700/50 hover:bg-slate-100 dark:hover:bg-slate-600/50 text-slate-700 dark:text-slate-300 rounded-lg transition-all disabled:opacity-50 border border-slate-300 dark:border-transparent shadow-sm"
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          {/* Time Period Buttons */}
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur border border-slate-300 dark:border-slate-700 rounded-xl p-6 shadow-sm">
                ...
                <button
                  ...
                  className={`px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-300 ${
                    selectedTimeframe === tf.key
                      ...
                      : "bg-slate-100 dark:bg-slate-700/50 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-600/50 border border-slate-300 dark:border-slate-600"
                  }`}
                >
                  {tf.label}
                </button>
          ...
          <div className="bg-white dark:bg-slate-800/50 backdrop-blur border border-slate-300 dark:border-slate-700 rounded-xl p-6 shadow-sm">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-2.5 bg-slate-100 dark:bg-slate-700/50 border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent appearance-none cursor-pointer font-semibold"
              >
                {branches.map((branch) => (
                  <option key={branch} value={branch} className="bg-white dark:bg-slate-800">
                    {branch}
                  </option>
                ))}
              </select>
              <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-600 dark:text-slate-400 pointer-events-none" />
            </div>
          </div>
        ...
        {showDatePicker && selectedTimeframe === "custom" && (
          <div className="mb-10 bg-white dark:bg-slate-800/50 backdrop-blur border border-slate-300 dark:border-slate-700 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <Calendar className="w-6 h-6 text-emerald-500 dark:text-emerald-400" />
                <h3 className="text-lg font-bold text-slate-900 dark:text-white">{uzbekTranslations.selectCustomDateRange}</h3>
              </div>
              <button
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-100 dark:bg-slate-700/50 border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent font-semibold cursor-pointer"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3 uppercase tracking-wider">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          {/* Top Employee Card */}
          {sortedData.length > 0 && (
            <div className="bg-gradient-to-br from-blue-100 via-indigo-50 to-slate-50 dark:from-blue-900/30 dark:via-indigo-900/20 dark:to-slate-900/30 border-2 border-blue-300 dark:border-blue-500/40 rounded-2xl p-8 backdrop-blur-sm hover:border-blue-400 dark:hover:border-blue-500/60 transition-all duration-300 shadow-lg">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider font-semibold">Исми:</p>
                  <p className="text-3xl font-bold text-slate-900 dark:text-white">{sortedData[0].name}</p>
                </div>
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider font-semibold">Филиал:</p>
                  <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{sortedData[0].branch}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {/* Top Branch Card */}
          {topBranchInfo && (
            <div className="bg-gradient-to-br from-emerald-100 via-teal-50 to-slate-50 dark:from-emerald-900/30 dark:via-teal-900/20 dark:to-slate-900/30 border-2 border-emerald-300 dark:border-emerald-500/40 rounded-2xl p-8 backdrop-blur-sm hover:border-emerald-400 dark:hover:border-emerald-500/60 transition-all duration-300 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-300 bg-clip-text text-transparent">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider font-semibold">Филиал:</p>
                  <p className="text-3xl font-bold text-emerald-600 dark:text-emerald-400">{topBranchInfo.branch}</p>
                </div>
                <div>
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-2 uppercase tracking-wider font-semibold">РОП (Менеджер):</p>
                  <p className="text-2xl font-bold text-slate-900 dark:text-white">{topBranchInfo.managerName}</p>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="mb-10">
          ...
          <div className="bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800/80 dark:to-slate-900/80 backdrop-blur border border-slate-300 dark:border-slate-700 rounded-xl p-8 hover:border-slate-400 dark:hover:border-slate-600 hover:shadow-xl transition-all duration-300 group">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-sm font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">{uzbekTranslations.activeEmployees}</h3>
            ...
            <p className="text-4xl font-bold text-slate-900 dark:text-white mb-2">{activeEmployees}</p>
        ...
        <div className="bg-white dark:bg-slate-800/50 backdrop-blur border border-slate-300 dark:border-slate-700 rounded-2xl overflow-hidden shadow-xl mb-10">
          <div className="px-8 py-6 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-800/50 dark:to-slate-900/50">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Филиаллар Рейтинги</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700">
                  <th className="px-8 py-4 text-left text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Ранг</th>
                  <th className="px-8 py-4 text-left text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Филиал</th>
                  <th className="px-8 py-4 text-left text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Менеджер</th>
                  <th className="px-8 py-4 text-right text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">6млн</th>
                  <th className="px-8 py-4 text-right text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Инвоис</th>
                  <th className="px-8 py-4 text-right text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">$3000</th>
                </tr>
              </thead>
              <tbody>
                {branchRankings.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-8 py-8 text-center text-slate-600 dark:text-slate-400">
                      ...
                      >
                        <td className="px-8 py-5">
                          <span className="text-2xl font-bold">
                            {isTopPerformer ? "🥇" : isTopThree ? (index === 1 ? "🥈" : "🥉") : <span className="text-slate-600 dark:text-slate-500 text-lg font-semibold">{index + 1}</span>}
                          </span>
                        </td>
                        <td className="px-8 py-5">
                          <p className="font-bold text-slate-900 dark:text-white text-lg">{branchData.branch}</p>
                        </td>
                        <td className="px-8 py-5">
                          <p className="text-slate-700 dark:text-slate-300">{branchData.manager}</p>
                        </td>
                        ...
                        <td className="px-8 py-5 text-right">
                          <p className="font-semibold text-blue-600 dark:text-blue-400 text-base">
                            {formatCurrency(branchData.invoice)}
                          </p>
                        </td>
                        <td className="px-8 py-5 text-right">
                          <p className="font-semibold text-purple-600 dark:text-purple-400 text-base">
        ...
        {/* Leaderboard Table */}
        <div className="bg-white dark:bg-slate-800/50 backdrop-blur border border-slate-300 dark:border-slate-700 rounded-2xl overflow-hidden shadow-xl">
          <div className="px-8 py-6 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-800/50 dark:to-slate-900/50">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{uzbekTranslations.employeeLeaderboard}</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700">
                  <th className="px-8 py-4 text-left text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">{uzbekTranslations.rank}</th>
                  <th className="px-8 py-4 text-left text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">{uzbekTranslations.name}</th>
                  <th className="px-8 py-4 text-left text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">{uzbekTranslations.branch}</th>
                  <th className="px-8 py-4 text-right text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">6млн</th>
                  <th className="px-8 py-4 text-right text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Инвоис</th>
                  <th className="px-8 py-4 text-right text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">$3000</th>
                </tr>
                  ...
                  sortedData.map((employee, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-8 py-5">
                          <p className="font-bold text-slate-900 dark:text-white text-lg">{employee.name}</p>
                        </td>
                        <td className="px-8 py-5">
                          <p className="text-slate-600 dark:text-slate-400">{employee.branch}</p>
                        </td>
                        <td className="px-8 py-5 text-right">
                          <p className="font-semibold text-emerald-600 dark:text-emerald-400 text-base">
        ...
        <div className="mt-10 text-center">
          <p className="text-slate-600 dark:text-slate-500 text-sm">
            {uzbekTranslations.lastUpdated}: <span className="text-slate-700 dark:text-slate-300 font-semibold">{new Date().toLocaleString("uz-UZ")}</span>
          </p>
